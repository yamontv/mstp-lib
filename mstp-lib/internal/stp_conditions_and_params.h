...
bool bridgeAssuranceEnabled      (const STP_BRIDGE*, PortIndex);
bool bridgeAssuranceInconsistent (const STP_BRIDGE*, PortIndex);
unsigned short bridgeAssuranceTimeout (const STP_BRIDGE*, PortIndex);
